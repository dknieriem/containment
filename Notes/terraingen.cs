...
public class TerrainGen {
    ...
    private float[2] randomVector(float scale) {
    ...
    public function generatePoints(int n, Extent extent) {
    ...
    private float[2] function centroid( float[][2] pts) {
        float x = 0;
        float y = 0;
    ...
    private float[][2] function improvePoints(float[][2] pts, int n, Extent extent) {
        n = n || 1;
        extent = extent || defaultExtent;
        for (var i = 0; i < n; i++) {
